...
- [RailWarden](https://github.com/advaith-1212/railwarden) - Deterministic execution-control plane for multi-agent software work with dependency-aware packages, isolated Git worktrees, durable validation evidence, recovery checkpoints, path ownership, and mechanical integration gates.
