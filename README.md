...
- [forge-harness](https://github.com/chrono-code/forge-harness) - Claude Code plugin for harness engineering with four structured methods: adversarial multi-wave validation (steel-quench), phantom claim detection (source-grounding-audit), session-learning capture (harvest-loop), and pre-deployment transfer simulation (sim-conductor). Preprint: https://doi.org/10.5281/zenodo.20397566
