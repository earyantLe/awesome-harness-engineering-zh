...
- [Better Harness](https://github.com/QoderAI/better-harness) - Cross-platform reviewer for coding-agent workflows that gathers task and repository evidence across task understanding, controlled execution, validation, delivery, and learning, then turns supported gaps into prioritized findings and repair plans while keeping unobserved behavior explicit.
